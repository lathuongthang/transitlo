...
if(location.hash){const id=location.hash.slice(1);if(map[id])setTimeout(()=>openCard(map[id],false),0);else if(id==='asean'||id==='vietnam')history.replaceState(null,'',location.pathname);}
})();
